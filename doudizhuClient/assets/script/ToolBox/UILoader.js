...
const UILoader = {
     ...
     * @param {} type 资源类型cc.SpriteFrame之类
    ...
    /**
     * 替换按钮纹理
     * @param {*} target 更换纹理的目标节点
     * @param {*} normalSprite 正常纹理文件
     * @param {*} pressedSprite 摁下纹理
     * @param {*} hoverSprite 悬浮纹理
     * @param {*} disabledSprite 关闭纹理
     */
